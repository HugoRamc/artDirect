...
public class modificaUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String nombre,contra,tarjeta,cvv,mes,anio;
            
            nombre = request.getParameter("txtNombre");
            contra = request.getParameter("txtPassword");
            tarjeta = request.getParameter("txtContra");
            cvv = request.getParameter("txtTarjeta");
            mes = request.getParameter("txtmes");
            anio = request.getParameter("txtYear");
            
            
            con.consulta("", mail,contra,nombre,tarjeta,cvv,mes,anio);
