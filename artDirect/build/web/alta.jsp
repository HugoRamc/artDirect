...
<body class="dos">
      ...
      </header><form action="" method="POST" name="alta" required>
           
          <h1>Join artDirect</h1>
          
	<table class="uno" align="center" required>
		
		
		<tr >
                    <td id="fila1"><label>Ingresa tu Nombre:</label><br><input type="text" class="form-control" name="txt" id="txt" required> <hr></td>

		</tr>
		<tr>
			<td>Ingresa tus Apellidos  <input type="text" class="form-control" name="txt1" id="txt2" required> <hr> </td>

		</tr>

		<tr>
			<td>Fecha de Nacimiento<input type="date" class="form-control" name="txt3" id="txt3" required><hr></td>

		</tr>

		<tr>
			<td>Pais  <select name="txt4" id="txt4" class="form-control"  required><option name="Canada">Canada</option>
		...
		<tr>
			<td>Ingresa tus Nick   <input type="text" class="form-control" name="txt5" id="txt5" required> <hr> </td>

		</tr>

		<tr>
			<td>Ingresa tu Contraseña  <input type="password" class="form-control" name="clave1" id="clave1" size="20" > <hr> </td>

		</tr>


		<tr>
			<td>Confirmar Contraseña <input type="password" class="form-control" name="clave2" id="clave2" size="20" > <hr> </td>
